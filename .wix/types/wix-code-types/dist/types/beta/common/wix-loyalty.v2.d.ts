declare module "wix-loyalty.v2" {
  ...
  interface LoyaltyCheckoutDiscount extends LoyaltyCheckoutDiscountDiscountOneOf {
       ...
       * - `DISCOUNT_AMOUNT`: A flexible reward type.
  ...
  interface ApplyDiscountToCheckoutRequest extends ApplyDiscountToCheckoutRequestDiscountOneOf {
      /** Unredeemed loyalty coupon discount. */
      reward?: Reward$1;
      /** Redeemed loyalty coupon discount. */
  ...
  interface Reward$1 {
      ...
      /**
       * Revision of the reward object you are applying.
       *
       * You must pass the current revision of the reward object.
       */
      revision?: string;
  }
  interface LoyaltyCoupon$1 {
      ...
      _id?: string;
      /**
       * Revision of the coupon object you are applying.
       *
       * You must pass the current revision of the coupon object.
       */
      revision?: string;
  }
  interface ReferralReward {
      ...
      _id?: string;
      /**
       * Revision of the referral reward you are applying.
       *
       * You must pass the current revision of the referral reward object.
       */
      revision?: string;
  }
  ...
  interface QueryLoyaltyCheckoutDiscountsRequest {
       ...
       * [Supported Filters](link/to/supported/filters/article).
       */
      query: CursorQuery$3;
  }
   ...
   * Supports three types of rewards: Flexible reward, Loyalty reward, Referral reward.
   ...
   *
   * For field support for filters and sorting, see [Loyalty Checkout Exchange: Supported Filters and Sorting](link/to/article).
   *
  ...
  /**
   * A Loyalty Import represents a batch import of loyalty points for existing customers.
   * You can use Loyalty Imports to import loyalty points from third-party providers or update existing customer point balances.
   */
  interface LoyaltyImport {
      ...
      _id?: string | null;
      /**
       * ID of the asynchronous import job associated with this Loyalty Import.
       * @readonly
       */
  ...
  interface FileMetadata {
      ...
      url?: string;
      /** Header values from the uploaded file. */
      header?: FileHeader;
      /** Information about how headers are mapped to loyalty data fields. */
      headerMappingInfo?: HeaderMappingInfo;
      /** Top 5 sample rows from the import file. */
  ...
  interface HeaderMappingInfo {
      /** Mappings between file headers and loyalty data fields. */
      headerMappings?: HeaderMapping[];
  }
  interface HeaderMapping {
      /** Name of the loyalty data column. */
      columnName?: ColumnName;
      /** Index of the column in the uploaded file. */
      columnIndex?: number;
  }
  enum ColumnName {
      /** Column containing the customer's email address. */
      EMAIL = "EMAIL",
      /** Column containing the customer's loyalty point balance. */
      POINTS = "POINTS"
  }
  interface SampleDataRow {
      /** Values in a sample data row. */
      values?: string[];
  }
  ...
  /**
   * Creates a new loyalty import.
   *
   * *Note**: The import file must be uploaded before creating a loyalty import object.
  ...
  /**
   * Retrieves the download URL for the error file of a loyalty import.
   *
   * >**Note**: This can be called when the error file status is available.
   * @param loyaltyImportId - Loyalty import ID.
   * @public
   * @documentationMaturity preview
   * @requiredField loyaltyImportId
   ...
   *
   * For field support for filters and sorting, see [Loyalty Imports: Supported Filters and Sorting](https://dev.wix.com/api/rest/wix-loyalty-program/loyalty-imports/supported-filters).
   *
   * To learn about working with query endpoints, see [API Query Language](https://dev.wix.com/api/rest/getting-started/api-query-language),
   * [Sorting and Paging](https://dev.wix.com/api/rest/getting-started/pagination),
   * and [Field Projection](https://dev.wix.com/api/rest/getting-started/field-projection).
   * @public
   * @documentationMaturity preview
  ...
  type loyaltyV1Account_universal_d_Tier = Tier;
  ...
  type loyaltyV1Account_universal_d_TiersRollingUpdate = TiersRollingUpdate;
  type loyaltyV1Account_universal_d_TiersProgramSettingsChanged = TiersProgramSettingsChanged;
  type loyaltyV1Account_universal_d_TiersProgramSettings = TiersProgramSettings;
  type loyaltyV1Account_universal_d_TiersProgramSettingsPeriodOneOf = TiersProgramSettingsPeriodOneOf;
  type loyaltyV1Account_universal_d_TierDefinition = TierDefinition;
  type loyaltyV1Account_universal_d_RollingWindow = RollingWindow;
  ...
  namespace loyaltyV1Account_universal_d {
    export {
      ...
      loyaltyV1Account_universal_d_Tier as Tier,
      ...
      loyaltyV1Account_universal_d_TiersRollingUpdate as TiersRollingUpdate,
      loyaltyV1Account_universal_d_TiersProgramSettingsChanged as TiersProgramSettingsChanged,
      loyaltyV1Account_universal_d_TiersProgramSettings as TiersProgramSettings,
      loyaltyV1Account_universal_d_TiersProgramSettingsPeriodOneOf as TiersProgramSettingsPeriodOneOf,
      Status$3 as Status,
      loyaltyV1Account_universal_d_TierDefinition as TierDefinition,
      loyaltyV1Account_universal_d_RollingWindow as RollingWindow,
  ...
  interface LoyaltyEarningRule extends LoyaltyEarningRuleTypeOneOf {
      /** An earning rule with a fixed amount of points you earn. */
      fixedAmount?: FixedAmount;
      /** An earning rule based on a conversion rate. */
       ...
       */
      _id?: string | null;
      /** ID of the app managing the rule. Can be either the loyalty app ID or an automations app ID. */
      sourceAppId?: string;
      /** ID of the app that triggers the points assignment. Examples: Stores, Bookings, Events. */
      triggerAppId?: string;
      /** Activity type that triggers points assignment. For example, `"wix-restaurants/orderSubmitted"` or `"birthday"`. */
  ...
  interface ConversionRate {
      ...
      /**
       * Field to use for sum in calculations.
       *
       * > **Note:** This field is applicable only for automation based earning rules.
       */
      field?: string | null;
  }
  interface ConversionRateConfig {
       ...
       * Points are awarded proportionally to the amount spent, with no minimum requirement.
       *
  ...
  enum Status$1 {
      ...
      ACTIVE = "ACTIVE",
      /** Earning rule is paused and cannot assign points. */
      PAUSED = "PAUSED"
  }
  interface Metadata {
  ...
  interface ListEarningRulesRequest {
      /** ID of the app that triggers the points assignment. */
      triggerAppId?: string | null;
      /** Type of activity that triggers the points assignment. */
   ...
   *
   * >**Note**: You can only create non-automation earning rules from a supported list.
   * For the supported list of services, see the [introduction](#link).
  ...
  /**
   * Creates multiple earning rules.
   *
   * >**Note**: You can only create non-automation earning rules from a supported list.
   * For the supported list of services, see the [introduction](#link).
  ...
  /**
   * Retrieves the specified non-automation earning rule.
   *
   * To get all earning rules, use [List Earning Rules](#link).
  ...
  /**
   * Retrieves an earning rule of type automation.
   *
   * Currently, only `v1` automation earning rules are supported. To get all earning rules, use [List Earning Rules](#link).
   * @param _id - ID of the earning rule to retrieve.
   * @public
   * @documentationMaturity preview
   * @requiredField _id
   ...
   *
   * To ensure a successful update, pass the latest `revision`.
  ...
  /**
   * Deletes a non-automation earning rule.
  ...
  /**
   * Deletes an earning rule of type automation.
   *
   * Only user-created automation earning rules can be deleted.
   *
   * To update the status of an earning rule, use the [Update earning rule](#link) endpoint.
   * @param _id - ID of the earning rule to delete.
   * @public
   * @documentationMaturity preview
   * @requiredField _id
   ...
   *
   * Returns both automation and non-automation earning rules.
   *
   * You can filter the results using the following parameters: `triggerAppId` or `triggerActivityType`
   * @public
   * @documentationMaturity preview
   */
  ...
  type loyaltyV1Program_universal_d_Status = Status;
  const loyaltyV1Program_universal_d_Status: typeof Status;
  ...
  namespace loyaltyV1Program_universal_d {
    export {
      ...
      loyaltyV1Program_universal_d_Status as Status,
      ...
      loyaltyV1Program_universal_d_StudioAssigned as StudioAssigned,
      loyaltyV1Program_universal_d_StudioUnassigned as StudioUnassigned,
      Empty$1 as Empty,
  ...
  type loyaltyV1Reward_universal_d_RestoreInfo = RestoreInfo;
  ...
  type loyaltyV1Reward_universal_d_MessageEnvelope = MessageEnvelope;
  type loyaltyV1Reward_universal_d_IdentificationData = IdentificationData;
  type loyaltyV1Reward_universal_d_IdentificationDataIdOneOf = IdentificationDataIdOneOf;
  type loyaltyV1Reward_universal_d_WebhookIdentityType = WebhookIdentityType;
  const loyaltyV1Reward_universal_d_WebhookIdentityType: typeof WebhookIdentityType;
  ...
  namespace loyaltyV1Reward_universal_d {
    export {
      ...
      loyaltyV1Reward_universal_d_DomainEvent as DomainEvent,
      loyaltyV1Reward_universal_d_DomainEventBodyOneOf as DomainEventBodyOneOf,
      loyaltyV1Reward_universal_d_EntityCreatedEvent as EntityCreatedEvent,
      loyaltyV1Reward_universal_d_RestoreInfo as RestoreInfo,
      loyaltyV1Reward_universal_d_EntityUpdatedEvent as EntityUpdatedEvent,
      loyaltyV1Reward_universal_d_EntityDeletedEvent as EntityDeletedEvent,
      loyaltyV1Reward_universal_d_ActionEvent as ActionEvent,
      loyaltyV1Reward_universal_d_Empty as Empty,
      loyaltyV1Reward_universal_d_MessageEnvelope as MessageEnvelope,
      loyaltyV1Reward_universal_d_IdentificationData as IdentificationData,
      loyaltyV1Reward_universal_d_IdentificationDataIdOneOf as IdentificationDataIdOneOf,
      loyaltyV1Reward_universal_d_WebhookIdentityType as WebhookIdentityType,
