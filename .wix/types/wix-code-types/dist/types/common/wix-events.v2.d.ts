declare module "wix-events.v2" {
     ...
     * @adminMethod
     */
    function queryTicketDefinitions$1(query: QueryV2$6, options?: QueryTicketDefinitionsOptions$1): Promise<QueryTicketDefinitionsResponse$1>;
    ...
    interface TicketDefinitionsQueryResult extends QueryCursorResult$4 {
    ...
    type eventsV3EventWixEventsV2_universal_d_V3EventStarted = V3EventStarted;
    type eventsV3EventWixEventsV2_universal_d_V3EventReminder = V3EventReminder;
    type eventsV3EventWixEventsV2_universal_d_TimeDuration = TimeDuration;
    type eventsV3EventWixEventsV2_universal_d_V3EventEnded = V3EventEnded;
    ...
    type eventsV3EventWixEventsV2_universal_d_V3EventPublished = V3EventPublished;
    ...
    type eventsV3EventWixEventsV2_universal_d_V3EventCanceled = V3EventCanceled;
     ...
     * Published form is visible to site visitors.
     */
    function getForm(eventId: string, options?: GetFormOptions): Promise<Form>;
     ...
     * @adminMethod
     */
    function publishDraft$1(eventId: string): Promise<PublishDraftResponse$2>;
    /**
    ...
    type eventsV1FormForms_universal_d_Form = Form;
    type eventsV1FormForms_universal_d_InputControl = InputControl;
    type eventsV1FormForms_universal_d_InputControlType = InputControlType;
    const eventsV1FormForms_universal_d_InputControlType: typeof InputControlType;
    type eventsV1FormForms_universal_d_Input = Input;
    type eventsV1FormForms_universal_d_ValueType = ValueType;
    const eventsV1FormForms_universal_d_ValueType: typeof ValueType;
    type eventsV1FormForms_universal_d_OptionSelection = OptionSelection;
    type eventsV1FormForms_universal_d_OptionSelectionSelectedOptionOneOf = OptionSelectionSelectedOptionOneOf;
    type eventsV1FormForms_universal_d_Label = Label;
    type eventsV1FormForms_universal_d_FormMessages = FormMessages;
    type eventsV1FormForms_universal_d_RsvpFormMessages = RsvpFormMessages;
    type eventsV1FormForms_universal_d_PositiveResponseConfirmation = PositiveResponseConfirmation;
    type eventsV1FormForms_universal_d_NegativeResponseConfirmation = NegativeResponseConfirmation;
    type eventsV1FormForms_universal_d_Positive = Positive;
    type eventsV1FormForms_universal_d_Negative = Negative;
    type eventsV1FormForms_universal_d_CheckoutFormMessages = CheckoutFormMessages;
    type eventsV1FormForms_universal_d_ResponseConfirmation = ResponseConfirmation;
    type eventsV1FormForms_universal_d_RegistrationClosedMessages = RegistrationClosedMessages;
    type eventsV1FormForms_universal_d_TicketsUnavailableMessages = TicketsUnavailableMessages;
    ...
    type eventsV1FormForms_universal_d_EventUpdated = EventUpdated;
    type eventsV1FormForms_universal_d_Location = Location;
    type eventsV1FormForms_universal_d_MapCoordinates = MapCoordinates;
    type eventsV1FormForms_universal_d_LocationType = LocationType;
    const eventsV1FormForms_universal_d_LocationType: typeof LocationType;
    type eventsV1FormForms_universal_d_ScheduleConfig = ScheduleConfig;
    type eventsV1FormForms_universal_d_Recurrences = Recurrences;
    type eventsV1FormForms_universal_d_Occurrence = Occurrence;
    type eventsV1FormForms_universal_d_Status = Status;
    const eventsV1FormForms_universal_d_Status: typeof Status;
    type eventsV1FormForms_universal_d_Event = Event;
    type eventsV1FormForms_universal_d_Scheduling = Scheduling;
    type eventsV1FormForms_universal_d_EventStatus = EventStatus;
    const eventsV1FormForms_universal_d_EventStatus: typeof EventStatus;
    type eventsV1FormForms_universal_d_Registration = Registration;
    type eventsV1FormForms_universal_d_RegistrationStatus = RegistrationStatus;
    const eventsV1FormForms_universal_d_RegistrationStatus: typeof RegistrationStatus;
    type eventsV1FormForms_universal_d_RsvpCollection = RsvpCollection;
    type eventsV1FormForms_universal_d_RsvpCollectionConfig = RsvpCollectionConfig;
    type eventsV1FormForms_universal_d_RsvpStatusOptions = RsvpStatusOptions;
    const eventsV1FormForms_universal_d_RsvpStatusOptions: typeof RsvpStatusOptions;
    type eventsV1FormForms_universal_d_Ticketing = Ticketing;
    type eventsV1FormForms_universal_d_TicketingConfig = TicketingConfig;
    type eventsV1FormForms_universal_d_TaxConfig = TaxConfig;
    type eventsV1FormForms_universal_d_ExternalEvent = ExternalEvent;
    type eventsV1FormForms_universal_d_VisitorType = VisitorType;
    const eventsV1FormForms_universal_d_VisitorType: typeof VisitorType;
    type eventsV1FormForms_universal_d_CalendarLinks = CalendarLinks;
    type eventsV1FormForms_universal_d_SiteUrl = SiteUrl;
    type eventsV1FormForms_universal_d_Dashboard = Dashboard;
    type eventsV1FormForms_universal_d_RsvpSummary = RsvpSummary;
    type eventsV1FormForms_universal_d_TicketingSummary = TicketingSummary;
    type eventsV1FormForms_universal_d_GuestListConfig = GuestListConfig;
    type eventsV1FormForms_universal_d_Feed = Feed;
    type eventsV1FormForms_universal_d_OnlineConferencing = OnlineConferencing;
    type eventsV1FormForms_universal_d_OnlineConferencingConfig = OnlineConferencingConfig;
    type eventsV1FormForms_universal_d_ConferenceType = ConferenceType;
    const eventsV1FormForms_universal_d_ConferenceType: typeof ConferenceType;
    type eventsV1FormForms_universal_d_OnlineConferencingSession = OnlineConferencingSession;
    type eventsV1FormForms_universal_d_SeoSettings = SeoSettings;
    type eventsV1FormForms_universal_d_SeoSchema = SeoSchema;
    type eventsV1FormForms_universal_d_Keyword = Keyword;
    type eventsV1FormForms_universal_d_Tag = Tag;
    type eventsV1FormForms_universal_d_Settings = Settings;
    type eventsV1FormForms_universal_d_Agenda = Agenda;
    type eventsV1FormForms_universal_d_Category = Category;
    type eventsV1FormForms_universal_d_CategoryCounts = CategoryCounts;
    type eventsV1FormForms_universal_d_State = State;
    const eventsV1FormForms_universal_d_State: typeof State;
    type eventsV1FormForms_universal_d_EventDisplaySettings = EventDisplaySettings;
    type eventsV1FormForms_universal_d_LabellingSettings = LabellingSettings;
    ...
    namespace eventsV1FormForms_universal_d {
        export { eventsV1FormForms_universal_d_Form as Form, eventsV1FormForms_universal_d_InputControl as InputControl, eventsV1FormForms_universal_d_InputControlType as InputControlType, eventsV1FormForms_universal_d_Input as Input, eventsV1FormForms_universal_d_ValueType as ValueType, eventsV1FormForms_universal_d_OptionSelection as OptionSelection, eventsV1FormForms_universal_d_OptionSelectionSelectedOptionOneOf as OptionSelectionSelectedOptionOneOf, eventsV1FormForms_universal_d_Label as Label, eventsV1FormForms_universal_d_FormMessages as FormMessages, eventsV1FormForms_universal_d_RsvpFormMessages as RsvpFormMessages, eventsV1FormForms_universal_d_PositiveResponseConfirmation as PositiveResponseConfirmation, eventsV1FormForms_universal_d_NegativeResponseConfirmation as NegativeResponseConfirmation, eventsV1FormForms_universal_d_Positive as Positive, eventsV1FormForms_universal_d_Negative as Negative, eventsV1FormForms_universal_d_CheckoutFormMessages as CheckoutFormMessages, eventsV1FormForms_universal_d_ResponseConfirmation as ResponseConfirmation, eventsV1FormForms_universal_d_RegistrationClosedMessages as RegistrationClosedMessages, eventsV1FormForms_universal_d_TicketsUnavailableMessages as TicketsUnavailableMessages, eventsV1FormForms_universal_d_FormInputControlAdded as FormInputControlAdded, eventsV1FormForms_universal_d_FormInputControlUpdated as FormInputControlUpdated, eventsV1FormForms_universal_d_FormInputControlDeleted as FormInputControlDeleted, eventsV1FormForms_universal_d_GetFormRequest as GetFormRequest, RequestedFields$1 as RequestedFields, eventsV1FormForms_universal_d_GetFormResponse as GetFormResponse, eventsV1FormForms_universal_d_AddControlRequest as AddControlRequest, eventsV1FormForms_universal_d_AddControlRequestControlOneOf as AddControlRequestControlOneOf, eventsV1FormForms_universal_d_PhoneControl as PhoneControl, eventsV1FormForms_universal_d_AddressControl as AddressControl, eventsV1FormForms_universal_d_AddressControlLabels as AddressControlLabels, eventsV1FormForms_universal_d_DateControl as DateControl, eventsV1FormForms_universal_d_AdditionalGuestsControl as AdditionalGuestsControl, eventsV1FormForms_universal_d_Labels as Labels, eventsV1FormForms_universal_d_DropdownControl as DropdownControl, eventsV1FormForms_universal_d_RadioButtonControl as RadioButtonControl, eventsV1FormForms_universal_d_CheckboxControl as CheckboxControl, eventsV1FormForms_universal_d_TextControl as TextControl, eventsV1FormForms_universal_d_AddControlResponse as AddControlResponse, eventsV1FormForms_universal_d_UpdateControlRequest as UpdateControlRequest, eventsV1FormForms_universal_d_UpdateControlRequestControlOneOf as UpdateControlRequestControlOneOf, eventsV1FormForms_universal_d_NameControl as NameControl, eventsV1FormForms_universal_d_NameControlLabels as NameControlLabels, eventsV1FormForms_universal_d_EmailControl as EmailControl, eventsV1FormForms_universal_d_UpdateControlResponse as UpdateControlResponse, eventsV1FormForms_universal_d_DeleteControlRequest as DeleteControlRequest, eventsV1FormForms_universal_d_DeleteControlResponse as DeleteControlResponse, eventsV1FormForms_universal_d_UpdateMessagesRequest as UpdateMessagesRequest, eventsV1FormForms_universal_d_UpdateMessagesResponse as UpdateMessagesResponse, PublishDraftRequest$2 as PublishDraftRequest, PublishDraftResponse$2 as PublishDraftResponse, eventsV1FormForms_universal_d_EventUpdated as EventUpdated, eventsV1FormForms_universal_d_Location as Location, eventsV1FormForms_universal_d_MapCoordinates as MapCoordinates, eventsV1FormForms_universal_d_LocationType as LocationType, Address$1 as Address, AddressStreetOneOf$1 as AddressStreetOneOf, StreetAddress$1 as StreetAddress, AddressLocation$1 as AddressLocation, Subdivision$1 as Subdivision, SubdivisionType$1 as SubdivisionType, eventsV1FormForms_universal_d_ScheduleConfig as ScheduleConfig, eventsV1FormForms_universal_d_Recurrences as Recurrences, eventsV1FormForms_universal_d_Occurrence as Occurrence, eventsV1FormForms_universal_d_Status as Status, eventsV1FormForms_universal_d_Event as Event, eventsV1FormForms_universal_d_Scheduling as Scheduling, eventsV1FormForms_universal_d_EventStatus as EventStatus, eventsV1FormForms_universal_d_Registration as Registration, EventType$1 as EventType, eventsV1FormForms_universal_d_RegistrationStatus as RegistrationStatus, eventsV1FormForms_universal_d_RsvpCollection as RsvpCollection, eventsV1FormForms_universal_d_RsvpCollectionConfig as RsvpCollectionConfig, eventsV1FormForms_universal_d_RsvpStatusOptions as RsvpStatusOptions, eventsV1FormForms_universal_d_Ticketing as Ticketing, eventsV1FormForms_universal_d_TicketingConfig as TicketingConfig, eventsV1FormForms_universal_d_TaxConfig as TaxConfig, TaxType$1 as TaxType, Money$1 as Money, eventsV1FormForms_universal_d_ExternalEvent as ExternalEvent, eventsV1FormForms_universal_d_VisitorType as VisitorType, eventsV1FormForms_universal_d_CalendarLinks as CalendarLinks, eventsV1FormForms_universal_d_SiteUrl as SiteUrl, eventsV1FormForms_universal_d_Dashboard as Dashboard, eventsV1FormForms_universal_d_RsvpSummary as RsvpSummary, eventsV1FormForms_universal_d_TicketingSummary as TicketingSummary, eventsV1FormForms_universal_d_GuestListConfig as GuestListConfig, eventsV1FormForms_universal_d_Feed as Feed, eventsV1FormForms_universal_d_OnlineConferencing as OnlineConferencing, eventsV1FormForms_universal_d_OnlineConferencingConfig as OnlineConferencingConfig, eventsV1FormForms_universal_d_ConferenceType as ConferenceType, eventsV1FormForms_universal_d_OnlineConferencingSession as OnlineConferencingSession, eventsV1FormForms_universal_d_SeoSettings as SeoSettings, eventsV1FormForms_universal_d_SeoSchema as SeoSchema, eventsV1FormForms_universal_d_Keyword as Keyword, eventsV1FormForms_universal_d_Tag as Tag, eventsV1FormForms_universal_d_Settings as Settings, eventsV1FormForms_universal_d_Agenda as Agenda, eventsV1FormForms_universal_d_Category as Category, eventsV1FormForms_universal_d_CategoryCounts as CategoryCounts, eventsV1FormForms_universal_d_State as State, eventsV1FormForms_universal_d_EventDisplaySettings as EventDisplaySettings, eventsV1FormForms_universal_d_LabellingSettings as LabellingSettings, DiscardDraftRequest$2 as DiscardDraftRequest, DiscardDraftResponse$2 as DiscardDraftResponse, DomainEvent$1 as DomainEvent, DomainEventBodyOneOf$1 as DomainEventBodyOneOf, EntityCreatedEvent$1 as EntityCreatedEvent, EntityUpdatedEvent$1 as EntityUpdatedEvent, EntityDeletedEvent$1 as EntityDeletedEvent, ActionEvent$1 as ActionEvent, MessageEnvelope$1 as MessageEnvelope, IdentificationData$1 as IdentificationData, IdentificationDataIdOneOf$1 as IdentificationDataIdOneOf, WebhookIdentityType$1 as WebhookIdentityType, eventsV1FormForms_universal_d_getForm as getForm, eventsV1FormForms_universal_d_GetFormOptions as GetFormOptions, eventsV1FormForms_universal_d_addControl as addControl, eventsV1FormForms_universal_d_AddControlOptions as AddControlOptions, eventsV1FormForms_universal_d_updateControl as updateControl, eventsV1FormForms_universal_d_UpdateControlIdentifiers as UpdateControlIdentifiers, eventsV1FormForms_universal_d_UpdateControlOptions as UpdateControlOptions, eventsV1FormForms_universal_d_deleteControl as deleteControl, eventsV1FormForms_universal_d_DeleteControlIdentifiers as DeleteControlIdentifiers, eventsV1FormForms_universal_d_updateMessages as updateMessages, eventsV1FormForms_universal_d_UpdateMessagesOptions as UpdateMessagesOptions, publishDraft$1 as publishDraft, discardDraft$1 as discardDraft, };
    }
    ...
    const eventsScheduleV1ScheduleItemSchedule_universal_d_discardDraft: typeof discardDraft;
    const eventsScheduleV1ScheduleItemSchedule_universal_d_publishDraft: typeof publishDraft;
    ...
    type eventsGuestsV1GuestGuests_universal_d_Address = Address;
    type eventsGuestsV1GuestGuests_universal_d_AddressStreetOneOf = AddressStreetOneOf;
    type eventsGuestsV1GuestGuests_universal_d_StreetAddress = StreetAddress;
    type eventsGuestsV1GuestGuests_universal_d_AddressLocation = AddressLocation;
    type eventsGuestsV1GuestGuests_universal_d_Subdivision = Subdivision;
    type eventsGuestsV1GuestGuests_universal_d_SubdivisionType = SubdivisionType;
    const eventsGuestsV1GuestGuests_universal_d_SubdivisionType: typeof SubdivisionType;
    ...
    type eventsGuestsV1GuestGuests_universal_d_EventType = EventType;
    const eventsGuestsV1GuestGuests_universal_d_EventType: typeof EventType;
    type eventsGuestsV1GuestGuests_universal_d_QueryEventGuestsRequest = QueryEventGuestsRequest;
    type eventsGuestsV1GuestGuests_universal_d_CursorPaging = CursorPaging;
    ...
    type eventsGuestsV1GuestGuests_universal_d_Empty = Empty;
    ...
    type eventsGuestsV1GuestGuests_universal_d_Money = Money;
    ...
    type eventsGuestsV1GuestGuests_universal_d_TaxType = TaxType;
    const eventsGuestsV1GuestGuests_universal_d_TaxType: typeof TaxType;
    ...
    type eventsGuestsV1GuestGuests_universal_d_FeeType = FeeType;
    const eventsGuestsV1GuestGuests_universal_d_FeeType: typeof FeeType;
    ...
    type eventsGuestsV1GuestGuests_universal_d_EventDeleted = EventDeleted;
    type eventsGuestsV1GuestGuests_universal_d_Task = Task;
    type eventsGuestsV1GuestGuests_universal_d_TaskKey = TaskKey;
    type eventsGuestsV1GuestGuests_universal_d_DomainEvent = DomainEvent;
    type eventsGuestsV1GuestGuests_universal_d_DomainEventBodyOneOf = DomainEventBodyOneOf;
    type eventsGuestsV1GuestGuests_universal_d_EntityCreatedEvent = EntityCreatedEvent;
    type eventsGuestsV1GuestGuests_universal_d_UndeleteInfo = UndeleteInfo;
    type eventsGuestsV1GuestGuests_universal_d_EntityUpdatedEvent = EntityUpdatedEvent;
    type eventsGuestsV1GuestGuests_universal_d_EntityDeletedEvent = EntityDeletedEvent;
    type eventsGuestsV1GuestGuests_universal_d_ActionEvent = ActionEvent;
    type eventsGuestsV1GuestGuests_universal_d_ListGuestListPreviewsRequest = ListGuestListPreviewsRequest;
    type eventsGuestsV1GuestGuests_universal_d_RequestedFields = RequestedFields;
    const eventsGuestsV1GuestGuests_universal_d_RequestedFields: typeof RequestedFields;
    ...
    type eventsGuestsV1GuestGuests_universal_d_MessageEnvelope = MessageEnvelope;
    type eventsGuestsV1GuestGuests_universal_d_IdentificationData = IdentificationData;
    type eventsGuestsV1GuestGuests_universal_d_IdentificationDataIdOneOf = IdentificationDataIdOneOf;
    type eventsGuestsV1GuestGuests_universal_d_WebhookIdentityType = WebhookIdentityType;
    const eventsGuestsV1GuestGuests_universal_d_WebhookIdentityType: typeof WebhookIdentityType;
    ...
    namespace eventsGuestsV1GuestGuests_universal_d {
        export { eventsGuestsV1GuestGuests_universal_d_EventGuest as EventGuest, eventsGuestsV1GuestGuests_universal_d_TicketDetails as TicketDetails, eventsGuestsV1GuestGuests_universal_d_TicketGuestDetails as TicketGuestDetails, eventsGuestsV1GuestGuests_universal_d_OnlineConferencingLogin as OnlineConferencingLogin, eventsGuestsV1GuestGuests_universal_d_GuestDetails as GuestDetails, eventsGuestsV1GuestGuests_universal_d_FormResponse as FormResponse, eventsGuestsV1GuestGuests_universal_d_InputValue as InputValue, eventsGuestsV1GuestGuests_universal_d_FormattedAddress as FormattedAddress, eventsGuestsV1GuestGuests_universal_d_Address as Address, eventsGuestsV1GuestGuests_universal_d_AddressStreetOneOf as AddressStreetOneOf, eventsGuestsV1GuestGuests_universal_d_StreetAddress as StreetAddress, eventsGuestsV1GuestGuests_universal_d_AddressLocation as AddressLocation, eventsGuestsV1GuestGuests_universal_d_Subdivision as Subdivision, eventsGuestsV1GuestGuests_universal_d_SubdivisionType as SubdivisionType, eventsGuestsV1GuestGuests_universal_d_StandardDetails as StandardDetails, eventsGuestsV1GuestGuests_universal_d_AttendanceStatus as AttendanceStatus, eventsGuestsV1GuestGuests_universal_d_GuestType as GuestType, eventsGuestsV1GuestGuests_universal_d_GuestCountUpdated as GuestCountUpdated, eventsGuestsV1GuestGuests_universal_d_GuestCountUpdate as GuestCountUpdate, eventsGuestsV1GuestGuests_universal_d_MemberEventStatusUpdated as MemberEventStatusUpdated, eventsGuestsV1GuestGuests_universal_d_MemberEventStatusUpdatedEventType as MemberEventStatusUpdatedEventType, eventsGuestsV1GuestGuests_universal_d_ContactEventStatusUpdated as ContactEventStatusUpdated, eventsGuestsV1GuestGuests_universal_d_EventType as EventType, eventsGuestsV1GuestGuests_universal_d_QueryEventGuestsRequest as QueryEventGuestsRequest, QueryV2$1 as QueryV2, QueryV2PagingMethodOneOf$1 as QueryV2PagingMethodOneOf, Sorting$1 as Sorting, SortOrder$1 as SortOrder, Paging$1 as Paging, eventsGuestsV1GuestGuests_universal_d_CursorPaging as CursorPaging, eventsGuestsV1GuestGuests_universal_d_RequestedFieldsEnumRequestedFields as RequestedFieldsEnumRequestedFields, eventsGuestsV1GuestGuests_universal_d_QueryEventGuestsResponse as QueryEventGuestsResponse, PagingMetadataV2$1 as PagingMetadataV2, Cursors$1 as Cursors, eventsGuestsV1GuestGuests_universal_d_StreamEventGuestsRequest as StreamEventGuestsRequest, eventsGuestsV1GuestGuests_universal_d_TaskContext as TaskContext, eventsGuestsV1GuestGuests_universal_d_NotifyActionType as NotifyActionType, eventsGuestsV1GuestGuests_universal_d_Empty as Empty, eventsGuestsV1GuestGuests_universal_d_NotifyGuestAction as NotifyGuestAction, eventsGuestsV1GuestGuests_universal_d_SecondaryLanguagesRequest as SecondaryLanguagesRequest, eventsGuestsV1GuestGuests_universal_d_SecondaryLanguagesResponse as SecondaryLanguagesResponse, eventsGuestsV1GuestGuests_universal_d_Language as Language, eventsGuestsV1GuestGuests_universal_d_RsvpCreated as RsvpCreated, eventsGuestsV1GuestGuests_universal_d_RsvpStatus as RsvpStatus, eventsGuestsV1GuestGuests_universal_d_Guest as Guest, eventsGuestsV1GuestGuests_universal_d_CheckIn as CheckIn, eventsGuestsV1GuestGuests_universal_d_RsvpUpdated as RsvpUpdated, eventsGuestsV1GuestGuests_universal_d_RsvpDeleted as RsvpDeleted, eventsGuestsV1GuestGuests_universal_d_OrderConfirmed as OrderConfirmed, eventsGuestsV1GuestGuests_universal_d_OrderStatus as OrderStatus, eventsGuestsV1GuestGuests_universal_d_Ticket as Ticket, eventsGuestsV1GuestGuests_universal_d_Money as Money, eventsGuestsV1GuestGuests_universal_d_Invoice as Invoice, eventsGuestsV1GuestGuests_universal_d_Item as Item, eventsGuestsV1GuestGuests_universal_d_Discount as Discount, eventsGuestsV1GuestGuests_universal_d_DiscountItem as DiscountItem, eventsGuestsV1GuestGuests_universal_d_DiscountItemDiscountOneOf as DiscountItemDiscountOneOf, eventsGuestsV1GuestGuests_universal_d_CouponDiscount as CouponDiscount, eventsGuestsV1GuestGuests_universal_d_PaidPlanDiscount as PaidPlanDiscount, eventsGuestsV1GuestGuests_universal_d_PaidPlanDiscountDiscountOneOf as PaidPlanDiscountDiscountOneOf, eventsGuestsV1GuestGuests_universal_d_PercentDiscount as PercentDiscount, eventsGuestsV1GuestGuests_universal_d_Tax as Tax, eventsGuestsV1GuestGuests_universal_d_TaxType as TaxType, eventsGuestsV1GuestGuests_universal_d_Fee as Fee, eventsGuestsV1GuestGuests_universal_d_FeeName as FeeName, eventsGuestsV1GuestGuests_universal_d_FeeType as FeeType, eventsGuestsV1GuestGuests_universal_d_OrderUpdated as OrderUpdated, eventsGuestsV1GuestGuests_universal_d_OrderDeleted as OrderDeleted, eventsGuestsV1GuestGuests_universal_d_OrderType as OrderType, eventsGuestsV1GuestGuests_universal_d_EventDeleted as EventDeleted, eventsGuestsV1GuestGuests_universal_d_Task as Task, eventsGuestsV1GuestGuests_universal_d_TaskKey as TaskKey, eventsGuestsV1GuestGuests_universal_d_DomainEvent as DomainEvent, eventsGuestsV1GuestGuests_universal_d_DomainEventBodyOneOf as DomainEventBodyOneOf, eventsGuestsV1GuestGuests_universal_d_EntityCreatedEvent as EntityCreatedEvent, eventsGuestsV1GuestGuests_universal_d_UndeleteInfo as UndeleteInfo, eventsGuestsV1GuestGuests_universal_d_EntityUpdatedEvent as EntityUpdatedEvent, eventsGuestsV1GuestGuests_universal_d_EntityDeletedEvent as EntityDeletedEvent, eventsGuestsV1GuestGuests_universal_d_ActionEvent as ActionEvent, eventsGuestsV1GuestGuests_universal_d_ListGuestListPreviewsRequest as ListGuestListPreviewsRequest, eventsGuestsV1GuestGuests_universal_d_RequestedFields as RequestedFields, eventsGuestsV1GuestGuests_universal_d_ListGuestListPreviewsResponse as ListGuestListPreviewsResponse, eventsGuestsV1GuestGuests_universal_d_GuestListPreview as GuestListPreview, eventsGuestsV1GuestGuests_universal_d_EventGuests as EventGuests, eventsGuestsV1GuestGuests_universal_d_GuestCount as GuestCount, eventsGuestsV1GuestGuests_universal_d_UpdateGuestRequest as UpdateGuestRequest, eventsGuestsV1GuestGuests_universal_d_UpdateGuestResponse as UpdateGuestResponse, eventsGuestsV1GuestGuests_universal_d_MessageEnvelope as MessageEnvelope, eventsGuestsV1GuestGuests_universal_d_IdentificationData as IdentificationData, eventsGuestsV1GuestGuests_universal_d_IdentificationDataIdOneOf as IdentificationDataIdOneOf, eventsGuestsV1GuestGuests_universal_d_WebhookIdentityType as WebhookIdentityType, eventsGuestsV1GuestGuests_universal_d_queryGuests as queryGuests, eventsGuestsV1GuestGuests_universal_d_QueryEventGuestsOptions as QueryEventGuestsOptions, eventsGuestsV1GuestGuests_universal_d_GuestsQueryResult as GuestsQueryResult, eventsGuestsV1GuestGuests_universal_d_GuestsQueryBuilder as GuestsQueryBuilder, eventsGuestsV1GuestGuests_universal_d_ListGuestListPreviewsOptions as ListGuestListPreviewsOptions, };
    }
    /** Schedule item describes the schedule within an event. Each event may contain multiple schedule items. */
    ...
    type eventsScheduleV1ScheduleItemScheduleBookmarks_universal_d_Paging = Paging;
    type eventsScheduleV1ScheduleItemScheduleBookmarks_universal_d_ListScheduleItemsResponse = ListScheduleItemsResponse;
    type eventsScheduleV1ScheduleItemScheduleBookmarks_universal_d_FacetCounts = FacetCounts;
    type eventsScheduleV1ScheduleItemScheduleBookmarks_universal_d_PagingMetadataV2 = PagingMetadataV2;
    type eventsScheduleV1ScheduleItemScheduleBookmarks_universal_d_Cursors = Cursors;
    type eventsScheduleV1ScheduleItemScheduleBookmarks_universal_d_QueryScheduleItemsRequest = QueryScheduleItemsRequest;
    type eventsScheduleV1ScheduleItemScheduleBookmarks_universal_d_QueryV2 = QueryV2;
    type eventsScheduleV1ScheduleItemScheduleBookmarks_universal_d_QueryV2PagingMethodOneOf = QueryV2PagingMethodOneOf;
    type eventsScheduleV1ScheduleItemScheduleBookmarks_universal_d_Sorting = Sorting;
    type eventsScheduleV1ScheduleItemScheduleBookmarks_universal_d_SortOrder = SortOrder;
    const eventsScheduleV1ScheduleItemScheduleBookmarks_universal_d_SortOrder: typeof SortOrder;
