declare module "wix-data.v2" {
  ...
  interface DataCollection {
      ...
      _updatedDate?: Date;
      /**
       * Levels of permission for accessing and modifying data. Updated using separate data permissions API
       * @internal
       * @readonly
       */
      dataPermissions?: DataPermissions;
      /**
       * Actual data operations permitted for caller, included only if requested by `include_allowed_data_permissions`
       * @internal
       * @readonly
       */
