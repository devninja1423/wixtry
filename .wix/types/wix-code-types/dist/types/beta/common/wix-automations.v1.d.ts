declare module "wix-automations.v1" {
  ...
  type automationsV1Automation_universal_d_UnprocessedTargetEvent = UnprocessedTargetEvent;
  type automationsV1Automation_universal_d_Target = Target;
  type automationsV1Automation_universal_d_TargetType = TargetType;
  const automationsV1Automation_universal_d_TargetType: typeof TargetType;
  ...
  namespace automationsV1Automation_universal_d {
    export {
      ...
      automationsV1Automation_universal_d_UnprocessedTargetEvent as UnprocessedTargetEvent,
      automationsV1Automation_universal_d_Target as Target,
      automationsV1Automation_universal_d_TargetType as TargetType,
