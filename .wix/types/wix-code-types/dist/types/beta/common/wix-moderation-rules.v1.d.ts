declare module "wix-moderation-rules.v1" {
  ...
  interface Rule {
      ...
      /**
       * Represents the time this Rule was created
       * @readonly
       */
      _createdDate?: Date;
      /**
       * Represents the time this Rule was last updated
       * @readonly
       */
      _updatedDate?: Date;
      /** Scope of the rule */
       ...
       * User can associate different actions per rule, but action execution should be done on API consumers side
       */
      action?: Action;
      /** Indicates if Rule is enabled. Disabled rule will not be checked */
      enabled?: boolean;
      /** Wix data extensions */
  ...
  /** Determines the duration of time (in hours) a member is considered new */
  interface NewMembersOptions {
      /** The duration that a member is considered new (in hours) */
  ...
  enum TriggerType {
      ...
      ATTRIBUTE = "ATTRIBUTE",
      /** This trigger applies to all content unconditionally */
      ALWAYS = "ALWAYS"
  }
  interface Patterns {
      /**
       * List of words. `*` wildcard can be used to match partial word. For example:<br>
       * `spam` - will match only "spam"<br>
       * `spam*` - will match "spam", "spammer", "spammy"<br>
       * `*spam` - will match "antispam", "multispam"<br>
       * `sp*m` - will match "spim", "spam", "spum"
       */
      words?: string[];
  ...
  interface ContentFeatures {
      ...
      links?: boolean;
      /** Content contain attachments/files */
      attachments?: boolean;
  }
  ...
  interface UpdateRuleRequest {
      /** Rule to be updated, may be partial. */
      rule: Rule;
      /**
  ...
  interface ModerationContent extends ModerationContentContentOneOf {
      /** Submitted content in Rich Content format */
      richContent?: RichContent;
      /** Submitted content as Plain Text */
  ...
  /**
   * Retrieves a list of Rules, given the provided [paging][1], [filtering, and sorting][2].
   *
   * Up to 1,000 Rules can be returned per request.
   *
   * To learn how to query Rules, see [API Query Language][3].
   *
  ...
  /**
   * `CheckContent` responsible for applying the available active rules to the provided content.
   * It scans the content for any conditions that might trigger a rule, and then returns actions which should be taken.
   * @public
   * @documentationMaturity preview
   * @adminMethod
   */
