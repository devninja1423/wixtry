declare module "wix-gift-cards-backend" {
  ...
  interface GiftCardProductsQueryBuilder {
       ...
       * @documentationMaturity preview
       */
      startsWith: (propertyName: '_id' | 'name' | 'presetVariants.id' | 'presetVariants.price', value: string) => GiftCardProductsQueryBuilder;
  ...
  export { giftCardsV1GiftCardProduct_universal_d as giftCardProduct };
}
