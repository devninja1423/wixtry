declare module "wix-media.v2" {
  ...
  type mediaSiteMediaV1FileDescriptor_universal_d_RestoreInfo = RestoreInfo;
  ...
  namespace mediaSiteMediaV1FileDescriptor_universal_d {
    export {
      ...
      mediaSiteMediaV1FileDescriptor_universal_d_RestoreInfo as RestoreInfo,
