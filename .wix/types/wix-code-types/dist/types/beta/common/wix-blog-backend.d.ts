declare module "wix-blog-backend" {
  ...
  interface CreateCategoryRequest {
       ...
       * @internal
       * @deprecated List of category fields to be included in the response.
  ...
  interface QueryDraftPostsRequest {
       ...
       * @internal
       * @deprecated Sorting options. For a list of sortable fields, see [Field Support for Filtering and Sorting](https://dev.wix.com/api/rest/wix-blog/blog/filter-and-sort).
       * @replacedBy query
       * @removalDate 2024-06-30
       */
      sort?: Sorting$2[];
  ...
  interface GetOrCreateTagRequest {
       ...
       * @internal
       * @deprecated List of tag fields to be included in the response.
       * @replacedBy fieldsets
       * @removalDate 2024-06-30
       */
