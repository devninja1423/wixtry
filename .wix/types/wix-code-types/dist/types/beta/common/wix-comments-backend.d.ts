declare module "wix-comments-backend" {
  ...
  interface CategoriesQueryBuilder {
       ...
       * @documentationMaturity preview
       */
      eq: (propertyName: '_id' | 'name' | 'reactionType' | 'repliesReactionType' | 'markedCommentLabelType' | 'customMarkedCommentLabel' | 'mainReaction.iconType' | 'ratingsSettings.ratingsEnabled' | 'ratingsSettings.ratingRequired', value: any) => CategoriesQueryBuilder;
      /** @param propertyName - Property whose value is compared with `value`.
       * @param value - Value to compare against.
       * @documentationMaturity preview
       */
      ne: (propertyName: '_id' | 'name' | 'reactionType' | 'repliesReactionType' | 'markedCommentLabelType' | 'customMarkedCommentLabel' | 'mainReaction.iconType' | 'ratingsSettings.ratingsEnabled' | 'ratingsSettings.ratingRequired', value: any) => CategoriesQueryBuilder;
      /** @documentationMaturity preview */
      in: (propertyName: '_id' | 'name' | 'reactionType' | 'repliesReactionType' | 'markedCommentLabelType' | 'customMarkedCommentLabel' | 'mainReaction.iconType', value: any) => CategoriesQueryBuilder;
      /** @param propertyNames - Properties used in the sort. To sort by multiple properties, pass properties as additional arguments.
       * @documentationMaturity preview
       */
  ...
  type commentsV1Category_universal_d_RestoreInfo = RestoreInfo;
  ...
  namespace commentsV1Category_universal_d {
    export {
      ...
      commentsV1Category_universal_d_RestoreInfo as RestoreInfo,
