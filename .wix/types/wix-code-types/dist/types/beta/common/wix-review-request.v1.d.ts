declare module "wix-review-request.v1" {
  ...
  interface ReviewRequestsQueryBuilder {
       ...
       * @documentationMaturity preview
       */
      eq: (propertyName: 'failedOptions' | 'failedOptions.reason' | 'failedOptions.message' | '_id' | 'revision' | '_createdDate' | '_updatedDate' | 'sendDate' | 'namespace' | 'eventId' | 'eventLabel' | 'entitiesToReview.id' | 'entitiesToReview.reviewData' | 'entitiesToReview.reviewData.reviewId' | 'entitiesToReview.reviewData.reviewSource' | 'recipient' | 'recipient.contactId' | 'activationId' | 'communicationChannel' | 'status' | 'opened' | 'extendedFields', value: any) => ReviewRequestsQueryBuilder;
      /** @param propertyName - Property whose value is compared with `value`.
       * @param value - Value to compare against.
       * @documentationMaturity preview
       */
      ne: (propertyName: 'failedOptions' | 'failedOptions.reason' | 'failedOptions.message' | '_id' | 'revision' | '_createdDate' | '_updatedDate' | 'sendDate' | 'namespace' | 'eventId' | 'eventLabel' | 'entitiesToReview.id' | 'entitiesToReview.reviewData' | 'entitiesToReview.reviewData.reviewId' | 'entitiesToReview.reviewData.reviewSource' | 'recipient' | 'recipient.contactId' | 'activationId' | 'communicationChannel' | 'status' | 'opened' | 'extendedFields', value: any) => ReviewRequestsQueryBuilder;
      /** @param propertyName - Property whose value is compared with `value`.
       * @param value - Value to compare against.
       * @documentationMaturity preview
       */
       ...
       * @documentationMaturity preview
       */
      hasSome: (propertyName: 'failedOptions' | 'failedOptions.reason' | 'failedOptions.message' | '_id' | 'revision' | '_createdDate' | '_updatedDate' | 'sendDate' | 'namespace' | 'eventId' | 'eventLabel' | 'entitiesToReview.id' | 'entitiesToReview.reviewData' | 'entitiesToReview.reviewData.reviewId' | 'entitiesToReview.reviewData.reviewSource' | 'recipient' | 'recipient.contactId' | 'activationId' | 'communicationChannel' | 'status' | 'opened' | 'extendedFields', value: any[]) => ReviewRequestsQueryBuilder;
      /** @documentationMaturity preview */
      in: (propertyName: 'failedOptions' | 'failedOptions.reason' | 'failedOptions.message' | '_id' | 'revision' | '_createdDate' | '_updatedDate' | 'sendDate' | 'namespace' | 'eventId' | 'eventLabel' | 'entitiesToReview.id' | 'entitiesToReview.reviewData' | 'entitiesToReview.reviewData.reviewId' | 'entitiesToReview.reviewData.reviewSource' | 'recipient' | 'recipient.contactId' | 'activationId' | 'communicationChannel' | 'status' | 'opened' | 'extendedFields', value: any) => ReviewRequestsQueryBuilder;
      /** @documentationMaturity preview */
      exists: (propertyName: 'failedOptions' | 'failedOptions.reason' | 'failedOptions.message' | '_id' | 'revision' | '_createdDate' | '_updatedDate' | 'sendDate' | 'namespace' | 'eventId' | 'eventLabel' | 'entitiesToReview.id' | 'entitiesToReview.reviewData' | 'entitiesToReview.reviewData.reviewId' | 'entitiesToReview.reviewData.reviewSource' | 'recipient' | 'recipient.contactId' | 'activationId' | 'communicationChannel' | 'status' | 'opened' | 'extendedFields', value: boolean) => ReviewRequestsQueryBuilder;
      /** @param propertyNames - Properties used in the sort. To sort by multiple properties, pass properties as additional arguments.
       * @documentationMaturity preview
       */
      ascending: (...propertyNames: Array<'failedOptions' | 'failedOptions.reason' | 'failedOptions.message' | '_id' | 'revision' | '_createdDate' | '_updatedDate' | 'sendDate' | 'namespace' | 'eventId' | 'eventLabel' | 'entitiesToReview' | 'entitiesToReview.id' | 'entitiesToReview.reviewData' | 'entitiesToReview.reviewData.reviewId' | 'entitiesToReview.reviewData.reviewSource' | 'recipient' | 'recipient.contactId' | 'activationId' | 'communicationChannel' | 'status' | 'opened' | 'extendedFields' | 'extendedFields.namespaces'>) => ReviewRequestsQueryBuilder;
      /** @param propertyNames - Properties used in the sort. To sort by multiple properties, pass properties as additional arguments.
       * @documentationMaturity preview
       */
